  ...
  $.app.menu = {
    ...
    changeMenu: function changeMenu(screen) {
      ...
      if (screen === 'xl') {
        ...
        dropdownMenu.addClass('custom-dropdown dropdown'); // dropdownMenu.child('a').addClass('dropdown-toggle nav-link');
        // dropdownMenu.children('ul').find('a').addClass('dropdown-item');

        dropdownMenu.find('ul').addClass('dropdown-menu'); // dropdownSubMenu.addClass().removeClass('has-sub');
      } else {
        // Change body classes
        ...
        // dropdownMenu.addClass('custom-dropdown');
        ...
        $('.custom-dropdown').on('click', function () {
          $(this).find('.dropdown-menu li').addClass('is-shown');
        });
...
$(window).on('resize load', function () {
  var dropdownMenu = $('li[data-menu="dropdown"]');

  if ($(window).width() < 991) {
    dropdownMenu.removeClass('dropdown').addClass('custom-dropdown');
    dropdownMenu.find('ul').removeClass('dropdown-menu');
  } else {
    dropdownMenu.addClass('custom-dropdown dropdown');
